-- Wave 14 bug fix #2/#3: distingue "empresa nunca registrou CIP" de
-- "tinha CIP mas venceu". Antes a view so tinha has_pest_service_active,
-- que era false em ambos casos — inflando o KPI alertsToday e travando
-- o score em 95% para empresas sem necessidade de CIP.
...
left join lateral (
  select
    ...
    -- NOVO: ao menos 1 servico foi registrado historicamente
