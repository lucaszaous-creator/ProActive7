    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-neutral-200 px-4 py-3 dark:border-neutral-800 sm:px-6">
          <h2 className="text-base font-semibold text-neutral-800 dark:text-neutral-100 sm:text-lg">
            {title}
          </h2>
          <button
            onClick={onClose}
        ...
        {footer && (
          <div className="flex justify-end gap-2 border-t border-neutral-200 px-4 py-3 dark:border-neutral-800 sm:px-6">
            {footer}
          </div>
        )}
      </div>
