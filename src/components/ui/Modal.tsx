...
export function Modal({
  ...
  return (
    <div
      className="fx-overlay-in fixed inset-0 z-50 flex items-end justify-center bg-black/40 backdrop-blur-[2px] sm:items-center sm:p-4"
      onClick={onClose}
    >
      <div
        className={`fx-modal-in flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-2xl bg-white shadow-2xl sm:rounded-2xl ${
      ...
      >
        ...
        {footer && (
          <div className="flex flex-wrap justify-end gap-2 border-t border-neutral-200 px-4 py-3 sm:px-6">
            {footer}
          </div>
        )}
      </div>
