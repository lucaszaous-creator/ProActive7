...
function FeedFallback() {
  return (
    <div className="flex flex-col items-center gap-4 rounded-3xl border border-dashed border-[#E8F1EA] bg-white px-6 py-12 text-center">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#A8543A] via-[#D4A857] to-[#6FA68A] text-white">
        <Instagram className="h-5 w-5" />
      </div>
      <div>
        <p className="text-base font-semibold text-[#1A2A22]">
          Feed do Instagram em breve.
        </p>
        <p className="mt-1 max-w-md text-sm text-[#1A2A22]/65">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center gap-2 rounded-full bg-[#2F5D3F] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-[#234731]"
      >
        Abrir @proactive.7
        <ArrowRight className="h-4 w-4" />
      </a>
